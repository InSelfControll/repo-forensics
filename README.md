...
2,208 tests across 40+ test files. Not synthetic toy examples: detection patterns built from real supply chain campaigns that hit production systems.
...
**The tests are safe to run.** All 2,208 tests use synthetic fixtures in temporary directories. No real malware is downloaded or executed. Pattern matching runs against fake package.json files containing attack signatures, the same way antivirus software tests against EICAR strings.
...
| **2,208 pytest tests** | Full coverage across 40+ test files |
